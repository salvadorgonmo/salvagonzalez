...
import './Resume.scss'
import { BriefcaseIcon, AcademicCapIcon, LightBulbIcon, CollectionIcon } from '@heroicons/react/outline'
...
export const Resume = () => {
  return (
    <div className='resume-container w-full h-full bg-white flex m-4'>
      <section className=' flex flex-col  w-full h-full ml-10 mr-10 mt-10 mb-10'>
        ...
        <section>
          <div id='description-card' className='mt-6 border-2 rounded-lg p-3 text-montserrat'>
