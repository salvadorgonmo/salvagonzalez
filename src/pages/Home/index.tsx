  ...
  return (
    <div className='home-container w-full'>
      ...
      <div className='img-container items-center flex flex-col sm:flex-row sm:justify-center'>
        <img src={MyProfilePicture} alt='Profile img' className='home-profile-picture' />
      ...
      <div className='m-10 flex flex-col items-center'>
          ...
          <div className='mt-6 flex flex-col items-center '>
            {!showMore && (
              <>
                <p className='mb-3 text-lato'>
                  More about myself...
                </p>
                <ChevronDownIcon className='bg-white cursor-pointer rounded-full border animate-bounce w-9 h-9 shadow-xl text-blue-700' onClick={handleShowMore} />
          ...
          <div id="collapsible-content" className='collapse'>
            <div className={`flex ${slideClass}  flex-wrap justify-center lg:flex-nowrap lg:justify-between`}>
              <div className='bg-white shadow-lg p-10 rounded-xl lg:mr-10 card-width'>
                ...
                I am Software Engineer that likes to do a bunch of things; either for technical as well as for personal hobbies. Let me first talk about technical ones.
              </p>

              <p className='mt-4 text-justify text-montserrat'>
                I like to read books and watch tutorials about new things, like new ways of doing the same sort of stuff; from transforming an array of strings with cool methods to apply new hooks that can lead to a better performance in a web application.
                I prefer to read books because I enjoy having them in a collection (a personal taste), like the "You don't know JS" book series from Kyle Simpson, which is my favorite one.
              </p>
              </div>
              ...
              <div className='flex flex-col p-10 items-center shadow-lg bg-white p-10 rounded-xl mt-10 lg:mt-0 card-width'>
                ...
                <p className='text-justify text-montserrat'>
                  I studied the Computer Systems Engineering career over 5 years, with an specialization of "Innovation and Software Quality".
                </p>
              </div>
            </div>

            <div className={`flex lg:justify-between ${slideClass} mb-10 flex-wrap justify-center lg:flex-nowrap`}>
              ...
              <p className='mt-4 text-justify text-montserrat'>
                I have had the opportunity to work with a different set of languages and technologies across my professional career.
              </p>
